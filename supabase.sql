...
-- ============================================================
-- RLS E POLÍTICAS PARA TESTE
-- ATENÇÃO: permissivas para fase de teste. Depois restringir por login/permissão.
-- ============================================================
...
DROP POLICY IF EXISTS "usuarios_teste_all" ON usuarios;
CREATE POLICY "usuarios_teste_all" ON usuarios FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "clientes_teste_all" ON clientes;
CREATE POLICY "clientes_teste_all" ON clientes FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "motoristas_teste_all" ON motoristas;
CREATE POLICY "motoristas_teste_all" ON motoristas FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "veiculos_teste_all" ON veiculos;
CREATE POLICY "veiculos_teste_all" ON veiculos FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "entregas_teste_all" ON entregas;
CREATE POLICY "entregas_teste_all" ON entregas FOR ALL USING (true) WITH CHECK (true);

DROP POLICY IF EXISTS "rotas_teste_all" ON rotas;
CREATE POLICY "rotas_teste_all" ON rotas FOR ALL USING (true) WITH CHECK (true);

INSERT INTO usuarios (nome, email, senha, cargo, permissao, ativo)
VALUES ('Administrador', 'admin@translog.com', 'admin123', 'Administrador', 'administrador', true)
ON CONFLICT (email) DO NOTHING;
